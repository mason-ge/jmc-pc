...
!function(self, arg) {
	var detailUrl = "com.jmc.scm.baseData.view.CltBaseDetail.d?action=new";
	var detailTitle = "创建客户主数据";
...
!function(self, arg) {
	...
	if (curr) {
		var currCode = curr.get('cltCode');
		var detailUrl = "com.jmc.scm.baseData.view.CltBaseDetail.d?action=mod&docCode="
				+ currCode;
		var detailTitle = "客户主数据详情页";
		top.competingEntity = arg.data;
		top.openUrlInFrameTab(detailUrl, detailTitle, "", true);
	}
};
...
!function(self, arg) {
	...
	if (curr) {
		var currCode = curr.get('cltCode');
		var detailUrl = "com.jmc.scm.baseData.view.CltBaseDetail.d?action=watch&docCode="
				+ currCode;
		var detailTitle = "客户主数据详情页";
		top.competingEntity = arg.data;
		top.openUrlInFrameTab(detailUrl, detailTitle, "", true);
