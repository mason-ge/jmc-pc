 ...
 */
@Entity
@Table(name = "client_bp")
public class ClientBp implements Serializable {
	 ...
	 * 积分:积分
	 */
	@PropertyDef(label = "积分", description = "积分:积分")
	...
	public ClientBp(String pkId, String client, String cltCode, String cltName,
			BigDecimal bp, String createdBy, Date createdD, String updatedBy,
	...
	public String toString() {
		return "ClientBp [pkId=" + pkId + ",client=" + client + ",cltCode="
				+ cltCode + ",cltName=" + cltName + ",bp=" + bp + ",createdBy="
