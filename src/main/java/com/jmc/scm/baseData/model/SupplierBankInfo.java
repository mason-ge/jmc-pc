...
public class SupplierBankInfo implements Serializable {
	...
	public SupplierBankInfo(String pkId, String client, String supCode,
	...
	public String toString() {
		return "SupplierBankInfo [pkId=" + pkId + ",client=" + client
				+ ",supCode=" + supCode + ",bankCntry=" + bankCntry
