 ...
 */
@Entity
@Table(name = "sale_po_item")
public class SalePoItem implements Serializable {
	 ...
	 * 行项目号:行项目号
	 */
	@PropertyDef(label = "行项目号", description = "行项目号:行项目号")
	...
	public SalePoItem(String pkId, String client, String salePoCode,
			String itemCode, String prodCode, String prodName,
			BigDecimal inlaiedScoop, String size, BigDecimal nums,
			String goldColor, String remark, String createdBy, Date createdD,
	...
	@Column(name = "SALE_PO_CODE", length = 30, nullable = false)
	...
	public String toString() {
		return "SalePoItem [pkId=" + pkId + ",client=" + client
				+ ",salePoCode=" + salePoCode + ",itemCode=" + itemCode
