...
/**
 * sale_out_main:SALE_OUT_MAIN
 */
@Entity
@Table(name = "sale_out_main")
public class SaleOutMain implements Serializable {
	 ...
	 * 销售类型:销售类型
	 */
	@PropertyDef(label = "销售类型", description = "销售类型:销售类型")
	 ...
	 * 出库类型:出库类型
	 */
	@PropertyDef(label = "出库类型", description = "出库类型:出库类型")
	private String outType;

	/**
	 * 客户本次积分:客户本次积分
	 */
	@PropertyDef(label = "客户本次积分", description = "客户本次积分:客户本次积分")
	private BigDecimal cltNowBp;
	 ...
	 * 推荐客户本次积分:推荐客户本次积分
	 */
	@PropertyDef(label = "推荐客户本次积分", description = "推荐客户本次积分:推荐客户本次积分")
	private BigDecimal intclientNowBp;

	/**
	 * 抵扣积分:抵扣积分
	 */
	@PropertyDef(label = "抵扣积分", description = "抵扣积分:抵扣积分")
	private BigDecimal dedtBp;

	/**
	 * 抵扣金额:抵扣金额
	 */
	@PropertyDef(label = "抵扣金额", description = "抵扣金额:抵扣金额")
	private BigDecimal dedtMoney;

	public SaleOutMain() {
		super();
	}

	public SaleOutMain(String pkId, String client, String saleCode,
			String saleType, String status, Date deliDate, String cltCode,
			...
			String attr5, String delFlg, String salePoCode, String outType,
			BigDecimal cltNowBp, String intclientCode,
			BigDecimal intclientNowBp, BigDecimal dedtBp, BigDecimal dedtMoney) {
		super();
		this.pkId = pkId;
		this.client = client;
		...
		this.cltNowBp = cltNowBp;
		this.intclientCode = intclientCode;
		this.intclientNowBp = intclientNowBp;
		this.dedtBp = dedtBp;
		this.dedtMoney = dedtMoney;
	}
	...
	@Column(name = "SALE_TYPE", length = 5, nullable = false)
	...
	@Column(name = "PAY_CON", length = 10, nullable = false)
	...
	@Column(name = "SALE_PO_CODE", length = 40)
	...
	public void setCltNowBp(BigDecimal cltNowBp) {
		this.cltNowBp = cltNowBp;
	}

	@Column(name = "CLT_NOW_BP")
	public BigDecimal getCltNowBp() {
		return cltNowBp;
	}
	...
	public void setIntclientNowBp(BigDecimal intclientNowBp) {
		this.intclientNowBp = intclientNowBp;
	}

	@Column(name = "INTCLIENT_NOW_BP")
	public BigDecimal getIntclientNowBp() {
		return intclientNowBp;
	}

	public void setDedtBp(BigDecimal dedtBp) {
		this.dedtBp = dedtBp;
	}

	@Column(name = "DEDT_BP")
	public BigDecimal getDedtBp() {
		return dedtBp;
	}

	public void setDedtMoney(BigDecimal dedtMoney) {
		this.dedtMoney = dedtMoney;
	}

	@Column(name = "DEDT_MONEY")
	public BigDecimal getDedtMoney() {
		return dedtMoney;
	}

	public String toString() {
		return "SaleOutMain [pkId=" + pkId + ",client=" + client + ",saleCode="
				+ saleCode + ",saleType=" + saleType + ",status=" + status
				+ ",deliDate=" + deliDate + ",cltCode=" + cltCode + ",cltName="
				+ cltName + ",cltAdd=" + cltAdd + ",phone=" + phone
				+ ",payCon=" + payCon + ",payment=" + payment + ",disctCmmt="
				+ disctCmmt + ",expressCmpy=" + expressCmpy + ",expressCode="
				+ expressCode + ",remark=" + remark + ",submitBy=" + submitBy
				+ ",submitD=" + submitD + ",createdBy=" + createdBy
				+ ",createdD=" + createdD + ",updatedBy=" + updatedBy
				+ ",updatedD=" + updatedD + ",attr1=" + attr1 + ",attr2="
				+ attr2 + ",attr3=" + attr3 + ",attr4=" + attr4 + ",attr5="
				+ attr5 + ",delFlg=" + delFlg + ",salePoCode=" + salePoCode
				+ ",outType=" + outType + ",cltNowBp=" + cltNowBp
				+ ",intclientCode=" + intclientCode + ",intclientNowBp="
				+ intclientNowBp + ",dedtBp=" + dedtBp + ",dedtMoney="
				+ dedtMoney + "]";
	}
