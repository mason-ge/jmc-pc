...
/**
 * prop_uni_info:成品单品属性表
 */
@Entity
@Table(name = "prop_uni_info")
public class PropUniInfo implements Serializable {
	...
	public PropUniInfo(String pkId, String client, String batchCode,
			String spName, String prodCode, String isEmptyBracket,
			...
			String cerType, String cerNum, String color, String neat,
			String ngtcGoods, BigDecimal ngtcTotQuality, String ngtcGFineness,
			BigDecimal inlaiedScoop, BigDecimal manStWt, String manStInfo,
			BigDecimal asstStWt, String asstStInfo, BigDecimal asstStAmt,
			String lauDate, String refOrderNum, String refLineNum,
			...
			String attr9, String attr10, String delFlg, String stockLocale,
			String mainStCode, String mainCerCode, String loan,
			String mainCerType, String otherCerType, String otherCerCode) {
		super();
		this.pkId = pkId;
		this.client = client;
	...
	@Column(name = "LCK_CLIENT_CODE", length = 20)
	...
	public String toString() {
		return "PropUniInfo [pkId=" + pkId + ",client=" + client
				+ ",batchCode=" + batchCode + ",spName=" + spName
				+ ",prodCode=" + prodCode + ",isEmptyBracket=" + isEmptyBracket
				...
				+ ",cerNum=" + cerNum + ",color=" + color + ",neat=" + neat
				+ ",ngtcGoods=" + ngtcGoods + ",ngtcTotQuality="
				+ ngtcTotQuality + ",ngtcGFineness=" + ngtcGFineness
				+ ",inlaiedScoop=" + inlaiedScoop + ",manStWt=" + manStWt
				+ ",manStInfo=" + manStInfo + ",asstStWt=" + asstStWt
				+ ",asstStInfo=" + asstStInfo + ",asstStAmt=" + asstStAmt
				+ ",lauDate=" + lauDate + ",refOrderNum=" + refOrderNum
				+ ",refLineNum=" + refLineNum + ",supCode=" + supCode
				+ ",supName=" + supName + ",status=" + status + ",remark="
				+ remark + ",lckClientCode=" + lckClientCode + ",lckDate="
				+ lckDate + ",lckRem=" + lckRem + ",qty=" + qty + ",createdBy="
				+ createdBy + ",createdD=" + createdD + ",updatedBy="
				+ updatedBy + ",updatedD=" + updatedD + ",attr1=" + attr1
				+ ",attr2=" + attr2 + ",attr3=" + attr3 + ",attr4=" + attr4
				+ ",attr5=" + attr5 + ",attr6=" + attr6 + ",attr7=" + attr7
				+ ",attr8=" + attr8 + ",attr9=" + attr9 + ",attr10=" + attr10
				+ ",delFlg=" + delFlg + ",stockLocale=" + stockLocale
				+ ",mainStCode=" + mainStCode + ",mainCerCode=" + mainCerCode
				+ ",loan=" + loan + ",mainCerType=" + mainCerType
