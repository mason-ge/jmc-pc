...
/**
 * stock_mv_detail:库存出入库明细表
 */
@Entity
@Table(name = "stock_mv_detail")
public class StockMvDetail implements Serializable {
	 ...
	 * 销售单号:销售单号
	 */
	@PropertyDef(label = "销售单号", description = "销售单号:销售单号")
	...
	public StockMvDetail() {
		super();
	}

	public StockMvDetail(String pkId, String client, String matCode,
			String matName, BigDecimal nums, String baseUnit,
			BigDecimal weight, Date storageDate, BigDecimal amount,
			String supCode, String supName, String saleCode, String remarks,
	...
	@Column(name = "SALE_CODE", length = 60)
	...
	public String toString() {
		return "StockMvDetail [pkId=" + pkId + ",client=" + client
				+ ",matCode=" + matCode + ",matName=" + matName + ",nums="
				+ nums + ",baseUnit=" + baseUnit + ",weight=" + weight
				+ ",storageDate=" + storageDate + ",amount=" + amount
				+ ",supCode=" + supCode + ",supName=" + supName + ",saleCode="
				+ saleCode + ",remarks=" + remarks + ",createdBy=" + createdBy
